...
export const successAuthorizationMessage = () => {
...
export const errorAuthorizationMessage = () => {
    toast.error("Customer account with the given credentials not found", {
        position: "top-center",
        autoClose: 2000,
        hideProgressBar: false,
        closeOnClick: true,
...
export const removeProductMessage = (value: string) => {
    toast.success(`${value} removed from the Basket`, {
        position: "top-center",
        autoClose: 2000,
        hideProgressBar: false,
        closeOnClick: true,
...
export const addProductMessage = () => {
    toast.success("Product is added to the Basket", {
        position: "top-center",
        autoClose: 2000,
        hideProgressBar: false,
        closeOnClick: true,
